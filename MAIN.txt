...
void mostrarInforme(struct MercaditoLibre *mercado)
{
    ...
    if (rec == NULL) {
        printf("No es posible mostrar un informe debido a que la lista de clientes esta vacia.\n\n");
        return;
    }
    ...
    {
        printf("No es posible mostrar un informe debido a que no se han realizado compras.\n\n");
        return;
    }
...
void mostrarRotacion(struct MercaditoLibre *mercado)
{
    ...
    {
        printf("No es posible mostrar la rotacion debido a que no hay productos registrados.\n\n");
    }
